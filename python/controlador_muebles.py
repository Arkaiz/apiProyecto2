    ...
    try:
        ...
        with conexion.cursor() as cursor:
            ...
            if mueble is not None:
                ...
                print("Mueble encontrado:", mueblejson)  # Log para depuración
            else:
                print("Mueble no encontrado para ID:", id)  # Log para depuración
        conexion.close()
        code = 200
    except Exception as e:
        print("Excepcion al recuperar un mueble:", str(e))  # Log para depuración
        code = 500
